...
Rol: Project Manager / Product Owner / Creador

## Contexto minimo

Lleken esta entrando en una fase de Beta 1 enfocada en cuidado individual robusto. La vision amplia incluye PAC, huertos comunitarios, B2B/B2G e IoT, pero la beta inmediata no debe intentar resolver todo.
...
- Convertir ideas grandes en fases.
- Detectar sobrealcance.
- Proponer criterios de aceptacion.
- Ayudarte a escribir decisiones claras en docs.
